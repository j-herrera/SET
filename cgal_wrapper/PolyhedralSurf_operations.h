...
template <class TPoly, class HEdgePropertyMap> class T_Polyhedron_hedge_ops
{
protected:
...
void T_Polyhedron_hedge_ops<TPoly, HEdgePropertyMap>::
...
template <class TPoly, class HEdgePropertyMap>
double T_Polyhedron_hedge_ops<TPoly, HEdgePropertyMap>::
...
//-------------------------------------------------------------------------------
template <class TPoly, class FacetPropertyMap> class T_Polyhedron_facet_ops
{
protected:
typedef typename TPoly::Vertex Vertex;
typedef typename TPoly::Halfedge_handle Halfedge_handle;
...
void T_Polyhedron_facet_ops<TPoly, FacetPropertyMap>::
...
template <class TPoly, class FacetPropertyMap>
typename TPoly::Traits::Vector_3 T_Polyhedron_facet_ops<TPoly, FacetPropertyMap>::
